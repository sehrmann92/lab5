...
void pusher(colloid* const c, const int* rx, const int* ry, const double step, const int N);
void statistics(const colloid* c, double& meanx, double& meany, double& var, const int N);
